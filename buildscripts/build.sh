...
loadarch () {
	...
	export CFLAGS="-O3 -mfpu=neon -march=armv8.2-a+crypto+dotprod+i8mm+bf16 -fno-plt -pipe -fvectorize -funroll-loops -mllvm -polly -mllvm -polly-run-inliner -mllvm -polly-ast-use-context -mllvm -polly-detect-keep-going -mllvm -polly-invariant-load-hoisting -mllvm -polly-vectorizer=stripmine -mllvm -polly-loopfusion-greedy=1 -mllvm -polly-reschedule=1 -mllvm -polly-postopts=1 -mllvm -polly-run-dce -mllvm -regalloc-enable-advisor=release -mllvm -hot-cold-split=true -flto=auto"
	export CXXFLAGS="-O3 -mfpu=neon -march=armv8.2-a+crypto+dotprod+i8mm+bf16 -fno-plt -pipe -fvectorize -funroll-loops -mllvm -polly -mllvm -polly-run-inliner -mllvm -polly-ast-use-context -mllvm -polly-detect-keep-going -mllvm -polly-invariant-load-hoisting -mllvm -polly-vectorizer=stripmine -mllvm -polly-loopfusion-greedy=1 -mllvm -polly-reschedule=1 -mllvm -polly-postopts=1 -mllvm -polly-run-dce -mllvm -regalloc-enable-advisor=release -mllvm -hot-cold-split=true -flto=auto"
	export AR=llvm-ar
