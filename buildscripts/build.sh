...
loadarch () {
	...
	export CFLAGS="-O3 -mfpu=neon -march=armv8.7-a -fno-plt -pipe -fvectorize -funroll-loops -mllvm -polly -mllvm -polly-run-inliner -mllvm -polly-ast-use-context -mllvm -polly-detect-keep-going"
	export CXXFLAGS="-O3 -mfpu=neon -march=armv8.7-a -fno-plt -pipe -fvectorize -funroll-loops -mllvm -polly -mllvm -polly-run-inliner -mllvm -polly-ast-use-context -mllvm -polly-detect-keep-going"
	export AR=llvm-ar
